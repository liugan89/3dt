...
public class ShipmentInActivity extends ShipBaseActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        bt_add_shipment.setText("添加入库单");
    }
    ...
    private void getShipmentUndoneDocs() {
        ...
        map.put("shipmentTypeId", "PURCHASE_SHIPMENT");
        map.put("StatusId", "notEq(PURCH_SHIP_RECEIVED)");
        ...
        NetUtil.getInstance().NoBody_Response(this, map, id, NetService.getShipments, new NetUtil.MyCallBack<List<ShipmentDetail>>() {
            ...
            public void onSuccess(List<ShipmentDetail> result) {
                ShipmentInActivity.this.shipmentDetails = result;
                initRV(shipmentDetails);
                if (result == null || result.isEmpty()) {
                    ToastUtil.showToast(ShipmentInActivity.this, "无未完成" + fun.getName() + "单");
                    return;
                }
            }
    ...
    protected void initRV(List<ShipmentDetail> os) {
        ...
        adapter.setRelationClickListener(new OnItemClickListener() {
            @Override
            public void onItemClick(int position) {
                Intent i = new Intent(ShipmentInActivity.this, RelateNoticeActivity.class);
    ...
    void click(View view) {
        switch (view.getId()) {
            case R.id.bt_add_shipment:
                Intent i1 = new Intent(ShipmentInActivity.this, RelateNoticeActivity.class);
