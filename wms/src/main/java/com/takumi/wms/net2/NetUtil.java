...
import static com.takumi.wms.widget.LoadingDialog.dismissDialog;
import static com.takumi.wms.widget.LoadingDialog.showDialog;
...
public class NetUtil {
    ...
    public <T> void NoDialogCall(final Context context, String path, Map map, Object o, int fun, final Type type, final MyCallBack<T> callBack) {
    ...
    public synchronized <T> void DialogCall(final Context context, String path, Map map, Object o, int fun, final Type type, final MyCallBack<T> callBack) {
        showDialog(context);
        final Observable<Response<ResponseBody>> ob = getFun(path, map, o, fun);
        obs.add(ob);
        ob.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Observer<Response<ResponseBody>>() {
     ...
     * @return
     */
    private Observable<Response<ResponseBody>> getFun(String path, Map map, Object o, int fun) {
        ...
        switch (fun) {
            ...
            case DELETE:
                if (o != null) {
                    ...
                    ob = netApi.deleteParam(path, map);
                }
                break;
        }
